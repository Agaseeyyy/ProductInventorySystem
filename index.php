    ...
    <div class="container px-2 max-w-[1536px] 2xl:max-w-[1280px] xl:max-w-[1024px]">
      ...
      <div class="flex flex-row items-center justify-between mb-6">
        ...
        <div class="flex space-x-4">
          <button onclick="openModal('add-product')" class="transition duration-300 right-0 flex items-center text-xs h-9 gap-1 shadow-[0_5px_5px_rgba(0,0,0,0.15)] px-3 text-white rounded-md bg-green-500 hover:bg-green-700 hover:shadow-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
            Add Product
          </button>
          <a href="product.php" class="flex-row gap-1 right-0 flex items-center text-xs h-9  shadow-[0_5px_5px_rgba(0,0,0,0.15)] px-3 text-white bg-yellow-500 rounded transition duration-300 hover:bg-yellow-600">
