  ...
  <div class="relative w-full max-w-2xl px-8 py-6 mx-4 transition-all transform bg-white shadow-2xl rounded-xl">
    ...
    <form id="generate-report-category" method="POST" action="">
      ...
      <div class="flex justify-end mt-6 space-x-3">
          ...
          <button type="submit" onclick="closeModal('generate-report-category')" class="text-xs px-3 py-2 text-white bg-yellow-500 rounded-md transition duration-300 hover:bg-yellow-700 shadow-[0_5px_5px_rgba(0,0,0,0.15)]">
              Generate Report
          </button>
      </div>
    </form>
