      ...
      <div class="flex flex-row justify-between gap-3">
        ...
        <div>
            <div class="flex items-center gap-2 px-3 text-sm text-gray-600">
              ...
              <select id="entries-suppliers" class="px-2 py-2 border rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-rose-500">
          ...
          <?php endif ?>
          <!-- Add Supplier Button -->
          <button onclick="openModal('add-supplier')" class="h-9 right-0 flex items-center text-xs gap-1 shadow-[0_5px_5px_rgba(0,0,0,0.15)] px-3 text-white rounded-md transition duration-300 bg-green-500 hover:bg-green-700 hover:shadow-none">
          ...
          <?php if (!empty($suppliers)): ?>
            <button onclick="openModal('generate-report-supplier')" class="flex items-center text-xs gap-1 shadow-[0_5px_5px_rgba(0,0,0,0.15)] h-9 px-3 text-white rounded-md bg-yellow-500 transition duration-300 hover:bg-yellow-700 hover:shadow-none">
